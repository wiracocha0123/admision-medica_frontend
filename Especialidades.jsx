...
export default function Especialidades() {
 ...
 <Button variant=\outlined\ startIcon={<RefreshIcon />} onClick={() => refetch()}>Actualizar</Button>
 <Button variant=\contained\ startIcon={<AddIcon />} onClick={() => handleOpen()}>Nueva Especialidad</Button>
 </Stack>
 </Stack>
